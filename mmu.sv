...
module mmu (
    ...
    output logic signed [16:0] partial_sum_out_0,
    output logic signed [16:0] partial_sum_out_1
);


    logic signed [7:0] pe00_01_activation, pe10_11_activation;
    logic signed [7:0] pe00_10_weight, pe10_11_weight;
    logic signed [16:0] pe00_10_partial_sum, pe01_11_partial_sum;
    ...
    pe pe00 (
        ...
        .in_partial_sum($signed({8'b0, col0_in})),
